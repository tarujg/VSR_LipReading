...
class LipNet(torch.nn.Module):
    def __init__(self, isTransformer=False, isDense=False, dropout_p=0.5):
        ...
        if self.isTrans:
            ...
            self.transformer_encoder = TransformerModel(96 * 4 * 8, 512, 8, 512, 3)
#             self.transformer_encoder = TransformerModel(16 * 4 * 8, 512, 8, 512, 4)
        else:
...
if __name__ == '__main__':
    ...
    net = LipNet(isTransformer=False, isDense=False)
